...
const BlogCard = (props: Blog) => {
  ...
  return (
    <Link
      href={slug}
      className="flex justify-between mt-8 pb-8 mobile:mt-6 mobile:pb-6 border-b-[1px] border-solid border-border-light w-full dark:border-border-dark mobile:my-8"
    >
