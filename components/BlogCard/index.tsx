...
const BlogCard = (props: Blog) => {
  ...
  return (
    <Link
      href={slug}
      className="slide-enter-content flex justify-between pb-8 mt-6 mobile:mt-6 mobile:pb-6 border-b-[1px] border-solid border-border-light w-full dark:border-border-dark mobile:my-8"
    >
