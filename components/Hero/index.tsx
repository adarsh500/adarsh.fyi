const Hero = () => {
  return (
    <main className="flex-1 flex items-center justify-center break-words text-xl flex-col text-left mt-16 mb-12 text-light-primary dark:text-dark-primary mobile:py-12 mobile:px-4 mobile:my-0">
      <div className="flex items-start justify-center flex-col">
        ...
        <p className="text-left mt-4 w-[90%] text-light-secondary text-xl leading-9 font-medium dark:text-dark-secondary mobile:text-lg mobile:leading-8 mobile:w-[100%] animate-fadeInUp">
