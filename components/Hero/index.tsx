...
const Hero = () => {
  return (
    <div className="flex flex-col gap-6 mt-24 mb-20">
      <main className="flex-1 flex items-center justify-center break-words text-xl flex-col text-left  text-dark-primary mobile:py-12 mobile:px-4 mobile:my-0">
