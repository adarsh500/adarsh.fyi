...
const ProjectCard = (props: ProjectProps) => {
  ...
  return (
    <div className="slide-enter-content group flex flex-col mr-9 cursor-pointer min-h-min w-[calc(50%-18px)] rounded-md bg-bg-light border border-solid border-border-light z-[1] dark:bg-bg-dark dark:border-border-dark mobile:w-full mobile:flex-row mobile:mr-0 mobile:mb-8 even:mr-0 hover:scale-101 hover:transition-all hover:duration-300 hover:ease-in-out hover:border-black hover:dark:border-white ">
